    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST") {
        ...
        if ($resultado->num_rows > 0) {
            ...
            try {
                ...
                $mail->Body    = 'Hola, este es tu código generado para la recuperación de tu contraseña: <br><br>' . $codigo . '. Por favor, ingresa el código en la página de <a href="localhost/ortographic/recuperacion-contraseña.php?id=' . $usuario . '">Recuperación de contraseña</a>';
                $mail->send();
                ...
                echo "<script>
                            Swal.fire({
                                ...
                                text: 'No se pudo enviar el mensaje. Error del correo: {$mail->ErrorInfo}.',
                            }).then((result) => {
